    ...
    <div className="bg-white">
      <section className="max-w-2xl mx-auto px-4 pt-20 pb-24">
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed text-[15px]">
          <p>
            努力して積み上げてきた経験が、会社の外に出ない。
            退職とともに、使われなくなる。
            そういう知見が、日本中にある。
          </p>
          <p>
            「他社はどうやっているか」——多くの現場で繰り返されるこの問いに、
            答えられる人がいない。経験した人の知見が、届く仕組みがないからだ。
          </p>
          <p>
            AIがその障壁を取り除いた。
            自分の経験を商品化する手順も、価格の設定も、今なら誰でもできる。
          </p>
          <p>
            経験イチバは、その知見が必要な人に届くための市場だ。
            ここに経験を出した人が「自分の積み上げが誰かの役に立った」と
            感じられる場所でありたい。
          </p>
        </div>
