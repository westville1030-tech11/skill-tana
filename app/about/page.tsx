    ...
    <div className="bg-white">
      <section className="max-w-2xl mx-auto px-4 pt-20 pb-24">
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed text-[15px]">
          ...
          <p>
            専門知識や公知情報はAIによって誰もが手にできる時代になりました。作業や知見がAIに置き換わっていく今、働く仕組みは大きな転換期にあります。
          </p>
          <p>
            これからのキャリアで本当に価値を持つのは、個人が積み上げた生きた現場での経験だと私たちは考えています。
          </p>
          <p>
            このプラットフォームのミッションは、埋もれている経験を掘り起こし、社会に循環させることです。
          </p>
        </div>
