...
DELIVERABLE_START
{"title":"商品タイトル（30字以内）","description":"成果物の説明（80字以内）","experience_story":"この経歴から読み取れる実体験ストーリー（150字程度、一人称なし）","ai_usage":"AIをどう使って納品するか（60字以内）","price_suggestion":30000,"days_suggestion":3,"service_type":"spot"}
DELIVERABLE_END

2つ目：コンサルティング型（対話・壁打ち・アドバイスセッションなど）
CONSULTING_START
{"title":"コンサル商品タイトル（30字以内）","description":"コンサル・セッションの説明（80字以内）","experience_story":"この経歴から読み取れる実体験ストーリー（150字程度、一人称なし）","ai_usage":"AIをどう使って納品するか（60字以内）","price_suggestion":15000,"days_suggestion":1,"service_type":"spot"}
CONSULTING_END`;
