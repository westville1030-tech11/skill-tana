...
DELIVERABLE_START
{"title":"商品タイトル（30字以内）","description":"成果物の説明（80字以内）","experience_story":"この経歴から読み取れる実体験ストーリー（150字程度、一人称なし）","ai_usage":"AIをどう使って納品するか（60字以内）","recommended_tools":["Claude","Perplexity"],"price_suggestion":30000,"days_suggestion":3,"service_type":"spot","price_rationale":"この価格が妥当な理由を経験の希少性・再現困難性で説明する1文（60字以内）"}
DELIVERABLE_END

2つ目：コンサルティング型（対話・壁打ち・アドバイスセッションなど）
CONSULTING_START
{"title":"コンサル商品タイトル（30字以内）","description":"コンサル・セッションの説明（80字以内）","experience_story":"この経歴から読み取れる実体験ストーリー（150字程度、一人称なし）","ai_usage":"AIをどう使って納品するか（60字以内）","recommended_tools":["Gemini","ChatGPT"],"price_suggestion":15000,"days_suggestion":1,"service_type":"spot","price_rationale":"この価格が妥当な理由を経験の希少性・再現困難性で説明する1文（60字以内）"}
CONSULTING_END
...
price_suggestionは成果物・経験の価値ベースで設定。price_rationaleは時間・工数への言及なし、経験の希少性や買い手が同等成果を得るコストとの比較で書く。`;
